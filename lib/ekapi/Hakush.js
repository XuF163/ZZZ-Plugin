...
// Example of how to run it directly (optional, for testing)
// You would typically import and call `updateHakushData` from your main plugin file.
/*
if (import.meta.url === `file://${process.argv[1]}`) { // Check if the script is run directly
    console.log("Running Hakush updater directly for testing...");
    updateHakushData().then(success => {
        console.log(`Direct run finished. Success: ${success}`);
